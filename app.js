...
//         var proxy = "https://cors-anywhere.herokuapp.com/"
    ...
    function parser(con, temp) {
        ...
        function getPhrase(condition, temp) {
            ...
            const random = Math.floor(Math.random() * (possiblePhrase.length - 1));
    ...
    function phrasemaker(ph) {
        ...
        processed.title += "\n<span id=subtext>\n" + ph.subline + "</span>";
        processed.effcolor = 'linear-gradient(45deg, #dadadada 20%, ' + ph.color[0] + ' 40%, ' + (ph.color[1] ? ph.color[1] : ph.color[0]) + ' 60%, #dadadada 80%)';
        return processed;
    }
})();
